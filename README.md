...
```mermaid
graph TD
    A[📋 Анализ требований] --> B[🎯 Тест-дизайн]
    B --> C[📝 Тестовая документация]
    C --> D[⚡ Выполнение тестов]
    D --> E[🐛 Баг-репортинг]
    E --> F[📊 Отчетность]
